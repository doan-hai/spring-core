...
public class CustomClientHttpRequestInterceptor implements ClientHttpRequestInterceptor {
    ...
    private void traceRequest(HttpRequest request, byte[] body) throws IOException {
        LOGGER.info("RestTemplate request logging: URI: {} Method: {} Headers: {} Body: {}", request.getURI(),
    ...
    private void traceResponse(ClientHttpResponse response, HttpRequest request) throws IOException {
        LOGGER.info("RestTemplate response logging: URI: {} Method: {} Status code: {} Headers: {} Body: {}",
                    request.getURI(), request.getMethod(), response.getStatusCode(), response.getHeaders(),
