...
public class RequestLoggingFilter implements Filter {
     ...
     * <p>
     * A typical implementation of this method would follow the following pattern:- <br> 1. Examine the request<br> 2.
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        logRequest((HttpServletRequest) request, serviceName, loggingProperties);
